...
<body class="bg-gray-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center mt-4">
                            <span class="text-xl font-bold text-blue-600">Rp 1.500.000 / malam</span>
                            <a href="detail_kamar.php?id_tipe=1" class="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center mt-4">
                            <span class="text-xl font-bold text-blue-600">Rp 800.000 / malam</span>
                            <a href="detail_kamar.php?id_tipe=2" class="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center mt-4">
                            <span class="text-xl font-bold text-blue-600">Rp 600.000 / malam</span>
                            <a href="detail_kamar.php?id_tipe=3" class="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600">Lihat Detail</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="cek-pesanan" class="py-20 bg-blue-50">
        <div class="container mx-auto px-6 max-w-2xl text-center">
            ...
            <form action="cek_pesanan.php" method="POST" class="flex flex-col md:flex-row gap-4">
                ...
                <input type="email" name="email" placeholder="Masukkan Email Anda" 
                       class="flex-1 p-3 border rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                <button type="submit" 
                        class="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-md transition duration-300">
                    Cek Sekarang
                </button>
            </form>
        </div>
