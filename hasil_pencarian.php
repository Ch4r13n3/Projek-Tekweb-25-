                ...
                <div class="bg-white rounded-xl shadow-lg flex flex-col md:flex-row overflow-hidden border">
                    ...
                    <div class="p-6 flex-1 flex justify-between items-start">
                        ...
                        <div class="text-right flex-shrink-0">
                            ...
                            if (isset($_SESSION['loggedin'])) {
                                $link_tujuan = "pemesanan.php?tipe_id=" . $kamar['id_tipe_kamar'] . "&checkin=$tgl_in&checkout=$tgl_out&jml=$jml_kamar";
                            } else {
                                // Jika belum login, arahkan ke login.php dengan parameter pesan
                                $link_tujuan = "login.php?pesan=wajib_login";
                            }
                            ?>
